    ...
    <>
      ...
      <div className="new-secc">
        <p className="new-seccc">
          ...
          support. If you think you'd be a great fit, we would love to hear from
          you.
        </p>
      </div>
      <div className="work-two">
        <h1 className="work-twoo">Current Vacancies</h1>
        <p className="work-twooo">
          There are no current vacancies. Please check again or register your
      ...
      <div className="work-three">
        <form className="formm">
          ...
          <p className="work-formm">
            Please register your interest below and we'll be in touch soon.
          </p>
          ...
          <br />
          <label className="femaill" for="email">
            Enter your Email*
          </label>
          <input type="email" id="emaiil" name="email" />
          <br />
          <label className="fphonee" for="phone">
            Phone*
          </label>
          <input
            type="tel"
          ...
          />
          <label className="ffile" for="file">
            Upload CV*
          </label>
          <input type="file" id="myFile" name="filename" />
          <br />
          <p className="maxx">Max. file size: 8 MB.</p>
          <label className="ftextt" for="text">
            {" "}
